"""
Django settings for intelliquery project.
...
SECRET_KEY = 'django-insecure-7#n9rv62g%$11-2)(k4+!gvo^j!^)^m=sh5c+(_7el!%j-l50+'
...
WSGI_APPLICATION = 'intelliquery.wsgi.application'
